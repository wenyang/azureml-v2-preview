...
from azure.ml._restclient.machinelearningservices.models import BanditPolicyConfiguration, \
    MedianStoppingPolicyConfiguration, TruncationSelectionPolicyConfiguration
