...
class JobLogManager(object):
    def __init__(self, runobject: RunOperations, experiment_name: str, job_name: str):
        ...
        self.POST_PROCESSING_STATES = JobStatus.get_post_processing_status()
    ...
    def wait_for_completion_and_stream_logs(self, weburi: str, raise_on_error=True):
    ...
    def _stream_run_output(self, file_handle=sys.stdout, raise_on_error=True):
    ...
    def get_job_status(self):
        ...
        :rtype: str
        """
        if self.status not in self.JOB_TERMINAL_STATES:
