...
from azure.ml._restclient.machinelearningservices.models import OnlineEndpointDeploymentResource, \
...
from azure.ml.constants import API_VERSION_2020_12_01_PREVIEW
from azure.ml._schema.online_endpoint_deployment_schema import OnlineEndpointDeploymentSchema, OnlineEndpointDeploymentYaml
