...
def ml_endpoint_create(cmd, resource_group_name, workspace_name, file, name=None, type=None):
    subscription_id = get_subscription_id(cmd.cli_ctx)
...
def ml_endpoint_delete(cmd, resource_group_name, workspace_name, name, type):
    subscription_id = get_subscription_id(cmd.cli_ctx)
...
def ml_endpoint_list(cmd, resource_group_name, workspace_name, type):
    subscription_id = get_subscription_id(cmd.cli_ctx)
