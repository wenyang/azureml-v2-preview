...
def load_environment_params(self):
    with self.argument_context("ml environment create") as c:
        ...
        c.argument(
            ...
            options_list=["--name", "-n"],
            type=str,
            help="The name under which the " "environment should be " "registered",
        )
    ...
    with self.argument_context("ml environment show") as c:
        add_common_params(c)
        c.argument(
            "environment_name", options_list=["--name", "-n"], type=str, help="The name of the environment to retrieve"
        )
        c.argument(
            "environment_version",
