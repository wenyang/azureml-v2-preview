...
from azure.machinelearning._datastore.datastore_utilities import create_azure_blob_storage_request
...
from azure.machinelearning._restclient.machinelearningservices.models import DatastoreCredentials, \
...
class DatastoreOperations(_WorkspaceDependentOperations):
    ...
    You should not instantiate this class directly. Instead, you should create MachineLearningClient and
    use this client via the property MachineLearningClient.datastores
    """
