...
from azure.machinelearning._restclient.machinelearningservices.models import RunDetailsDto
...
class RunOperations(_WorkspaceDependentOperations):
    ...
    def get_run_details(self,  exp_name: str, run_id: str) -> RunDetailsDto:
        return self._operation.get_details(self._workspace_scope.subscription_id, self._workspace_scope.resource_group_name, self._workspace_name, exp_name, run_id)
