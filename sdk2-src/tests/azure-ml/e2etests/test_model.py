...
from unittest.mock import __version__, patch
import pytest
import uuid
...
flavors:
  ...
  python_function:
    ...
    python_version: 3.8.5""")
        with patch('azure.ml._artifacts._artifact_utilities.get_object_hash', return_value=randstr):
        ...
        with pytest.raises(Exception):
            with patch('azure.ml._artifacts._artifact_utilities.get_object_hash', return_value="DIFFERENT_HASH"):
                client.model.create_or_update(file=artifact_path)
