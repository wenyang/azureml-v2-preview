...
@pytest.mark.e2etest
def test_environment_create_or_update_conda(client: MLClient, randstr: str) -> None:
...
@pytest.mark.e2etest
def test_environment_create_or_update_python(client: MLClient, randstr: str) -> None:
    environment_name = randstr
    environment_version = random.randint(0, 100000)
    environment = client._environments.create_or_update(
        environment_name=environment_name,
...
@pytest.mark.e2etest
def test_environment_create_or_update_docker(client: MLClient, randstr: str) -> None:
    environment_name = randstr
    environment_version = random.randint(0, 100000)
    environment = client._environments.create_or_update(
        environment_name=environment_name,
