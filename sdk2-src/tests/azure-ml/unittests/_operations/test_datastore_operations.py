...
class TestDatastoreOperations:
    ...
    def test_show_no_secrets_with_secrets(self, mock_datastore_operation: DatastoreOperations, randstr: str) -> None:
    ...
    def test_attach_azure_blob_storage(
        ...
        mock_datastore_operation.attach_azure_blob_storage(
            datastore_name, azure_storage_container_name, azure_storage_account_name
        )
    ...
    def test_get_default_with_secrets(self, mock_datastore_operation: DatastoreOperations):
