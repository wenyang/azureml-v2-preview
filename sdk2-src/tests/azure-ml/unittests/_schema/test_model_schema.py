...
class TestModelSchema:
    ...
    def test_deserialize_env_with_only_name(self) -> None:
        ...
        with open(path, 'r') as f:
            ...
            schema = ModelSchema(context=context)
            internal_model = schema.load(target)
            assert internal_model.environment == '/subscriptions/5f08d643-1910-4a38-a7c7-84a39d4f42e0/resourceGroups/sdk_vnext_cli/providers/Microsoft.MachineLearningServices/Environments/AzureML-Minimal/versions/1'
        ...
        with open(path, 'r') as f:
            ...
            schema = ModelSchema(context=context)
            internal_model = schema.load(target)
            assert internal_model.environment == 'Environments/AzureML-Minimal/versions/1'
