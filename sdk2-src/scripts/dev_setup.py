...
def setup_sdk(args: Namespace, shell: bool) -> None:
    ...
    restclient_path = Path("./src/azure-machinelearning/azure/machinelearning/_restclient/")
    ...
    run_command(commands=['pip', 'install', '-e', f'{Path("./src/azure-machinelearning/").absolute()}'], shell=shell)
...
if __name__ == "__main__":
    ...
    if args.t:
        ...
        run_command(commands=['pytest', f'{Path("tests/azure-machinelearning/unittests").absolute()}'], shell=shell)
