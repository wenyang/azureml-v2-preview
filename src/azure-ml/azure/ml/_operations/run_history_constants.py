...
class RunHistoryConstants(object):
    ...
    ALL_STATUSES = [JobStatus.QUEUED, JobStatus.PREPARING, JobStatus.PROVISIONING, JobStatus.STARTING,
                    JobStatus.RUNNING, JobStatus.CANCEL_REQUESTED, JobStatus.CANCELED,
                    JobStatus.FINALIZING, JobStatus.COMPLETED, JobStatus.FAILED, JobStatus.NOT_STARTED,
                    JobStatus.FAILED, JobStatus.PAUSED, JobStatus.NOTRESPONDING]
    IN_PROGRESS_STAUSES = [JobStatus.NOT_STARTED,
                           JobStatus.QUEUED,
                           JobStatus.PREPARING,
    ...
    TERMINAL_STATUSES = [JobStatus.COMPLETED, JobStatus.FAILED, JobStatus.CANCELED, JobStatus.NOTRESPONDING, JobStatus.PAUSED]
