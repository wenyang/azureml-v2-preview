...
class EnvironmentOperations(_WorkspaceDependentOperations):
    ...
    def create_or_update(self,
        ...
        environment_name = environment_name if environment_name is not None else environment.name
        environment_version = environment_version if environment_version is not None else environment.version
    ...
    def _load(self,
              ...
              environment_version: Optional[str]) -> InternalEnvironment:
        try:
            if file is not None:
