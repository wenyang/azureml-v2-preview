...
class EnvironmentOperations(_WorkspaceDependentOperations):
    ...
    def create_or_update(
        ...
        **kwargs: Any,
        ...
        environment = self._load(
            file=file, environment_name=environment_name, environment_version=environment_version, **kwargs
        )
    ...
    def get(self, environment_name: str, environment_version: int) -> EnvironmentSpecificationVersionResource:
        """
        Gets a specific version of an environment
        """

        result = self._version_operations.get(
    ...
    def get_latest_version(self, environment_name: str) -> EnvironmentSpecificationVersionResource:
        """
    ...
    def list_versions(self, environment_name: str):
        """
    ...
    def _load(self, file: Union[str, os.PathLike, None], **kwargs: Optional[dict]) -> InternalEnvironment:
        try:
            if file is not None:
        ...
        try:
            ...
            environment: InternalEnvironment = EnvironmentSchema(context=context).load(
                cfg, unknown=RAISE
            )  # type: ignore
            return environment
