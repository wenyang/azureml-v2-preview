...
from .schema import PatchedBaseSchema, PatchedNested

from azure.ml._restclient.machinelearningservices.models import BatchRetrySettings, BatchPartitioningScheme, \
    BatchOutputConfiguration, BatchDeploymentSettings
