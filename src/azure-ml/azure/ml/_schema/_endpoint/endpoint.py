...
from azure.ml.constants import AssetType, ACI, MANAGED
...
class EndpointSchema(PathAwareSchema):
    ...
    infrastructure = UnionField([ArmStr(asset_type=AssetType.COMPUTE), fields.Str(validate=validate.OneOf([MANAGED, ACI]))],
                                missing=MANAGED)
