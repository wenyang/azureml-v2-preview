...
from azure.ml._restclient.machinelearningservices.models import EnvironmentSpecificationVersionResource, DockerProperties, \
    PythonProperties, EnvironmentSpecificationVersion
