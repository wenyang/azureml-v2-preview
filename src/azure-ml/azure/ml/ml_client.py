...
class MLClient(object):
    def __init__(self,
        ...
        self._endpoints = EndpointOperations(self._workspace_scope, self._service_client, self._operation_container, **kwargs)
        ...
        self._jobs = JobOperations(self._workspace_scope, self._service_client, self._code, self._workspaces, self._datastores, **kwargs)
