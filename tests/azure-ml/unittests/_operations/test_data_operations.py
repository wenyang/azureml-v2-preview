...
class TestDataOperations:
    def test_list(self, mock_data_operations: DataOperations) -> None:
        ...
        mock_data_operations._operation.list.assert_called_once_with(
            name_only, Test_Subscription, Test_Resource_Group, Test_Workspace_Name, Default_API_Version, skip_token=None
        )

        mock_data_operations.list()
        mock_data_operations._container_operation.list.assert_called_once_with(
            Test_Subscription, Test_Resource_Group, Test_Workspace_Name, Default_API_Version, skip_token=None
        )
    ...
    def test_get(self, mock_data_operations: DataOperations) -> None:
        ...
        mock_data_operations._operation.get.assert_called_once_with(
            name_only, str(version), Test_Subscription, Test_Resource_Group, Test_Workspace_Name, Default_API_Version
        )
    ...
    def test_delete(self, mock_data_operations: DataOperations) -> None:
        ...
        mock_data_operations._operation.delete.assert_called_once_with(
            name_only, str(version), Test_Subscription, Test_Resource_Group, Test_Workspace_Name, Default_API_Version
        )
