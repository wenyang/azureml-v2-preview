...
class TestJobOperations:
    ...
    def test_get_latest(self, mock_environment_operation: EnvironmentOperations, randstr: str) -> None:
        mock_environment_operation.get_latest(randstr)
        mock_environment_operation._version_operations.get_latest.assert_called_once()
    ...
    def test_create_or_update(self, mock_environment_operation: EnvironmentOperations, randstr: str) -> None:
        mock_environment_operation.create_or_update(
            ...
            file="./tests/test_configs/environment_test.yml")
