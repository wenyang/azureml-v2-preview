...
def test_create_directory(client: MLClient) -> None:
    ...
    obj = client.data.create_or_update(yaml_path=data_yaml)
    ...
    assert (
        data_version.datastore
        == "azureml:/subscriptions/4faaaf21-663f-4391-96fd-47197c630979/resourceGroups/static_sdk_cli_v2_test_e2e/providers/Microsoft.MachineLearningServices/workspaces/sdk_vnext_cli/datastores/workspaceblobstore"
    )
