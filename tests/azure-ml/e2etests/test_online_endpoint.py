...
from azure.ml._restclient.machinelearningservices.models import ComputeResource
...
def test_online_endpoint_aks_e2e(client: MLClient) -> None:
    ...
    create_endpoint_yaml = "tests/test_configs/online_endpoint_create_aks.yaml"
